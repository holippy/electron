...
ArticleStore.dispatcher.action = {
  dispatch: function dispatch(payload, data, boolean) {
  ...
  create: function create(payload) {
    ...
    xhr.done(function (data) {
      _this.dispatch(payload, data, 'false');
    });
  }
};
...
ArticleStore.dispatcher.publish = function (data) {
...
},{"flux":6,"jQuery":8}],2:[function(require,module,exports){
'use strict';
    ...
    if (this.state.data.length === 0) {
      ...
      var lists = this.state.data.map(function (res) {
        return React.createElement(
          'li',
          { key: res.id },
          React.createElement('img', { src: res.images.thumbnail.url })
        );
      });
      return React.createElement(
        'ul',
...
var topRender = ReactDOM.render(React.createElement(Article, null), document.getElementById('LytContainer'));

module.exports = Article;

},{"./_article-store":1,"react":166,"react-dom":10}],3:[function(require,module,exports){
'use strict';
...
var topRender = ReactDOM.render(React.createElement(Pager, null), document.getElementById('LytPager'));

module.exports = Pager;

},{"./_article-store":1,"react":166,"react-dom":10}],4:[function(require,module,exports){
'use strict';
...
var articleJSX = require('./_pager.jsx');

},{"./_article.jsx":2,"./_pager.jsx":3,"jQuery":8}],5:[function(require,module,exports){
(function (process){
/**
...
},{"_process":9,"fbjs/lib/invariant":5}],8:[function(require,module,exports){
/*!
